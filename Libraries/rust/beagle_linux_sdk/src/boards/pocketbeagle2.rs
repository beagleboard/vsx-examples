...
pub const USER_LED1: &str = "/sys/class/leds/beaglebone:green:usr1";
pub const USER_LED2: &str = "/sys/class/leds/beaglebone:green:usr2";
pub const USER_LED3: &str = "/sys/class/leds/beaglebone:green:usr3";
pub const USER_LED4: &str = "/sys/class/leds/beaglebone:green:usr4";
