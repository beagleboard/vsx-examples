...
#bh.beagle_box_3(
  ...
  === Debian Linux Minimal (non-graphical) image
...
#bh.grid_column(
  bh.beagle_box_4(img: "images/chapter1/step1.webp", img_height: 120pt, col1: step_box)[Start with fresh ingredients, nothing plugged in.],
  bh.beagle_box_4(img: "images/chapter1/step2.webp", img_height: 120pt, col1: step_box)[Insert your pre-flashed Micro SD Card provided by your instructor into PocketBeagle 2 MicroSD slot.],
)
...
#bh.grid_column(
  bh.beagle_box_4(img: "images/chapter1/step4.webp", img_height: 100pt, col1: step_box)[USB connection provides powers to your PocketBeagle 2, you should see a Red LED light marked ‘P’ lit up.],
  bh.beagle_box_4(img: "images/chapter1/step5.webp", img_height: 100pt, col1: step_box)[Wait for 2 minutes while your PocketBeagle 2 computer boots up to start a network connection.],
)
...
#bh.grid_column(
  bh.beagle_box_4(img: "images/chapter1/step7.webp", img_height: 150pt, col1: step_box)[If a warning like this is shown on your screen then click on #strong[Advanced] button to open up an option.],
  bh.beagle_box_4(img: "images/chapter1/step8.webp", img_height: 150pt, col1: step_box)[Click on #strong[Proceed to 192.168.7.2 (unsafe)] button to access Visual Studio Code Server, this is a one time process only.],
)
...
#block(width: 100%, fill: bc.dark_orange.lighten(93%), inset: 7pt, radius: 7pt)[
  #grid(
    columns: (auto, auto),
    row-gutter: 7pt,
    grid.cell(colspan: 2)[==== Why Does the 'Your connection is not private' Warning Show Up?],
...
#block(width: 100%, stroke: bc.dark_orange.lighten(60%) + 1pt, radius: 6pt, inset: 8pt)[
  #grid(
    ...
    column-gutter: 8pt,
    grid.cell(align: horizon, step_box),
    grid.cell(align: horizon, text(size: 8pt)[Click on #strong[Yes, I trust the authors] button to start exploring examples.]),
...
#bh.grid_column(
  columns: (70%, 30%),
  bh.beagle_box_4(img: "images/chapter1/step11.webp", img_height: 180pt, col1: step_box)[
    Navigate to the blinky example present at location shown below: #strong[vsx-examples/PocketBeagle-2/blinky/python/main.py]
  ],
  bh.beagle_box_4(img: "images/chapter1/step12.webp", img_height: 180pt, col1: step_box)[Click on #strong[RUN] button to run the Blinky example code],
)

#bh.beagle_box_6(img: "images/chapter1/step13.webp", v_height: 140pt, col_width: 260pt, col1: step_box)[Observe the text ON & OFF printed in the terminal and the green Light marked with text 4 blinking in sync with the text!]

#bh.beagle_box_4(img: "images/chapter1/step14.webp", col1: step_box)[
  On line 5 change the path to blink any other light of your choice, to test let’s replace #strong[usr4] at the end with #strong[usr1] to blink light 1 Updated code on line 5 for Blinking the light 1 should look like this: #strong[LED = Path("/sys/class/leds/beaglebone:green:usr1")] On line 6 update #strong[number_of_blinks] from #strong[5] to #strong[10] as well, hit #strong[RUN] button and observe Light 1 blinking for 10 times.
]
